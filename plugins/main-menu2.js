...
let str = `*Hai Ngab*`
let isi =`I'm LuluBotz Yang Di Buat Gak Niat Oleh Xyro Karena Males Recode Jadi Pake Aja Apa Yang Ada Yah.\nKalau Ada Yg Error Bisa Langsung Report Ke Owner.\n${tag} (Owner)`
...
conn.send3ButtonImg(m.chat, `https://telegra.ph/file/116c1a217394d408415c9.jpg`, str, isi, 'Menu', '.command', 'Owner', '.owner', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/xyrostore_real',
    mediaType: 2, 
    description: urlnya,
    title: "Follow Ig Gw",
    body: wm,
    thumbnail: thumb,
    sourceUrl: 'https://instagram.com/xyrostore_real'
     }}
  })
          }
handler.help = ['menu']
